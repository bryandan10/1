...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <link rel="icon" href="<?php echo e(asset('plantilla/images/favicon.ico')); ?>" type="image/x-icon">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('plantilla/css/bootstrap.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('plantilla/css/fonts.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('plantilla/css/style.css')); ?>">
    <style>.ie-panel{display: none;background: #212121;padding: 10px 0;box-shadow: 3px 3px 5px 0 rgba(0,0,0,.3);clear: both;text-align:center;position: relative;z-index: 1;} html.ie-10 .ie-panel, html.lt-ie-10 .ie-panel {display: block;}</style>
  </head>
  <body>
    <div class="ie-panel"><a href="http://windows.microsoft.com/en-US/internet-explorer/"><img src="<?php echo e(asset('plantilla/images/ie8-panel/warning_bar_0000_us.jpg')); ?>" height="42" width="820" alt="You are using an outdated browser. For a faster, safer browsing experience, upgrade for free today."></a></div>
    <div class="preloader">
    ...
    <div class="page">
      ...
      <header class="section page-header page-header-2 section-custom-1-ally">
            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a class="brand" href="index.html"><img class="brand-logo-dark" src="<?php echo e(asset('plantilla/images/logo-default-195x39.png')); ?>" alt="" width="195" height="39"/><img class="brand-logo-light" src="<?php echo e(asset('plantilla/images/logo-inverse-195x39.png')); ?>" alt="" width="195" height="39"/></a>
                  </div>
                </div>
                <div class="rd-navbar-aside-outer">
                  ...
                  <div class="rd-navbar-aside" id="rd-navbar-aside">
                    <ul class="rd-navbar-aside-list">
                      <li><span class="icon mdi mdi-map-marker"></span><a href="#">6 Diciembre St. Robles, UIO 170143</a></li>
              ...
              <div class="rd-navbar-nav-wrap">
                ...
                <ul class="rd-navbar-nav">
                  <li class="rd-nav-item active"><a class="rd-nav-link" href="<?php echo e(route('home')); ?>">Home</a>
                  </li>
                  </li>
                  <li class="rd-nav-item"><a class="rd-nav-link" href="<?php echo e(route('login')); ?>">Inicia Sesión</a>
                  </li>
                  <li class="rd-nav-item"><a class="rd-nav-link" href="<?php echo e(route('register')); ?>">Registro</a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div class="jumbotron-3">
          <div class="parallax-container jumbotron-3-inner context-dark" data-parallax-img="<?php echo e(asset('plantilla/images/bg-image-01.jpg')); ?>">
                ...
                <div class="row row-40">
                  <div class="col-md-6 col-lg-12">
                    <div class="d-flex justify-content-between">
                      <h4 class="text-uppercase font-weight-sbold wow fadeIn">Our Mision</h4><span class="icon mdi icon-sm linearicons-pencil3"></span>
                    </div>
                    <!-- RD Mailform-->
                    <label>
                      The Metropolitan Languages ​​School (MLS) trains professionals with high levels of communicative competence in both the mother tongue and the foreign language, in correspondence with the actions declared in the National Plan for Good Living. He specializes in both undergraduate and continuing education and in the training and improvement of language teachers under the principles of sustainability.
                    </label>
                    <div class="d-flex justify-content-between">
                      <h4 class="text-uppercase font-weight-sbold wow fadeIn">Our Vision</h4><span class="icon mdi icon-sm linearicons-pencil3"></span>
                    </div>
                    <label>
                      Until 2020, the Metropolitan Languages ​​School (MLS) is a reference center for undergraduate training, continuing education and the improvement of language teachers in Ecuador, demonstrated in the excellence of the cloister and in the alliance with international centers with experience in Language teaching
                    </label>
                  </div>
                  <div class="col-md-6 col-lg-12">
                ...
                <div class="row row-30 mt-xl-60">
                  <div class="col-sm-6 wow fadeIn">
                    <article class="tour-minimal context-dark">
                      <div class="tour-minimal-inner img-overlay" style="background-image: url('<?php echo e(asset('plantilla/images/home-3-2-258x273.jpg')); ?>');">
                  ...
                  <div class="col-sm-6 wow fadeIn" data-wow-delay=".05s">
                    <article class="tour-minimal context-dark">
                      <div class="tour-minimal-inner img-overlay" style="background-image: url('<?php echo e(asset('plantilla/images/home-3-3-258x273.jpg')); ?>');">
                        <div class="tour-minimal-header">
                        </div>
                        <div class="tour-minimal-main">
                  ...
                  <div class="col-sm-6 wow fadeIn" data-wow-delay=".05s">
                    <article class="tour-minimal context-dark">
                      <div class="tour-minimal-inner img-overlay" style="background-image: url('<?php echo e(asset('plantilla/images/home-3-4-258x273.jpg')); ?>');">
                        <div class="tour-minimal-header">
                        </div>
                        <div class="tour-minimal-main">
                  ...
                  <div class="col-sm-6 wow fadeIn" data-wow-delay=".1s">
                    <article class="tour-minimal context-dark">
                      <div class="tour-minimal-inner img-overlay" style="background-image: url('<?php echo e(asset('plantilla/images/home-3-5-258x273.jpg')); ?>');">
                        <div class="tour-minimal-header">
                        </div>
                        <div class="tour-minimal-main">
        ...
        <div class="container">
          <div class="row row-30 row-sm-50 justify-content-center justify-content-lg-between">
            <div class="col-sm-10 col-md-10 col-lg-8">
              ...
              <div class="post-corporate-gallery post-corporate-gallery-2 inset-1" data-lightgallery="group"><a class="post-corporate-thumbnail post-corporate-thumbnail-1 post-corporate-thumbnail-custom" href="<?php echo e(asset('plantilla/images/group-01-original.jpg')); ?>" data-lightgallery="item"><img class="post-corporate-thumbnail-image" src="<?php echo e(asset('plantilla/images/group-01-722x490.jpg')); ?>" alt="" width="722" height="490"/></a><a class="post-corporate-thumbnail post-corporate-thumbnail-5" href="<?php echo e(asset('plantilla/images/group-02-original.jpg')); ?>" data-lightgallery="item"><img class="post-corporate-thumbnail-image" src="<?php echo e(asset('plantilla/images/group-02-360x326.jpg')); ?>" alt="" width="360" height="326"/></a><a class="post-corporate-thumbnail post-corporate-thumbnail-5" href="<?php echo e(asset('plantilla/images/group-03-original.jpg')); ?>" data-lightgallery="item"><img class="post-corporate-thumbnail-image" src="<?php echo e(asset('plantilla/images/group-03-360x326.jpg')); ?>" alt="" width="360" height="326"/></a></div>
            </div>
                ...
                <div class="col-md-6 col-lg-12">
                  <article class="box-8 mt-30 mt-xl-60 wow fadeIn" data-wow-delay=".1s">
                    <ul class="list-pricing">
                      <li><a href="#"><span class="list-pricing-title">Language for Business</span><span></span></a></li>
                      <li><a href="#"><span class="list-pricing-title">English for Kids</span><span></span></a></li>
                      <li><a href="#"><span class="list-pricing-title">Online Learning</span><span></span></a></li>
                      <li><a href="#"><span class="list-pricing-title">German Club</span><span></span></a></li>
                      <li><a href="#"><span class="list-pricing-title">Personal Lessons</span><span></span></a></li>
                      <li><a href="#"><span class="list-pricing-title">Group Lessons</span><span></span></a></li>
                      <li><a href="#"><span class="list-pricing-title">French for Beginners</span><span></span></a></li>
                    </ul>
                  </article>
                </div>
                <div class="col-md-6 col-lg-12">
      ...
      <!-- Join Our Newsletter -->
      <section class="section section-xl context-dark bg-image bg-overlay-1 text-center" style="background-image:  url('<?php echo e(asset('plantilla/images/bg-image-3.jpg')); ?>');">
        <div class="container">
      ...
      <footer class="section footer-classic footer-classic-md">
        <div class="footer-classic-main">
          <div class="container">
            <div class="footer-classic-layout justify-content-sm-around justify-content-md-between">
              <div class="footer-classic-layout-item"><a class="brand" href="index.html"><img class="brand-logo-dark" src="<?php echo e(asset('plantilla/images/logo-default-195x39.png')); ?>" alt="" width="195" height="39"/><img class="brand-logo-light" src="<?php echo e(asset('plantilla/images/logo-inverse-195x39.png')); ?>" alt="" width="195" height="39"/></a>
        ...
        <div class="footer-classic-aside">
          <div class="container">
            <p class="rights"><span>&copy;&nbsp; </span><span class="copyright-year"></span><span>&nbsp;</span><span>Bradcor</span><span>. Todos los derechos reservados.</span><span> Diseñado por <a href="https://www.templatemonster.com">Bradcor</a></span></p>
          </div>
        </div>
      </footer>
    </div>
    <div class="snackbars" id="form-output-global"></div>
    <script src="<?php echo e(asset('plantilla/js/core.min.js')); ?>"></script>
    <script src="<?php echo e(asset('plantilla/js/script.js')); ?>"></script>
  </body>
</html>