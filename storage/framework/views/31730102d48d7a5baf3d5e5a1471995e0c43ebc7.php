...
<title>MLS | Registrar matricula</title>
...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">Registro de Matricula</h4>
            ...
            <div class="col-md-6">
                <div class="card">
                    <?php echo Form::open(['route' => 'matriculas.store', 'files'=>true]); ?>
                        ...
                        <?php echo csrf_field(); ?>
                        <?php echo $__env->make('matriculas.partial.form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <?php echo Form::close(); ?>
